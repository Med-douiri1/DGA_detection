...
def load_data(file_path):
    ...
    y = to_categorical(df['superfamily_label'])
    return X, y
...
# Reduce learning rate when we hit a plateau
lr_scheduler = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=3, verbose=1)
# Save the best version of our model
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('loss_superfamilies.png')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_superfamilies.png')
